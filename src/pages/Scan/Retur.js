...
export default function Retur({ navigation, route }) {
    ...
    const __getTransaction = () => {
        // setLoading(true);
        axios.get(APIurl + 'retur?id_member=' + route.params.id).then(res => {
    ...
    const __deleteData = (barcode) => {
        axios.delete(APIurl + 'retur?id_member=' + user.id + '&key=' + barcode).then(res => {
    ...
    const __filterData = (barcode) => {
        // setLoading(true);
        axios.get(APIurl + 'retur?id_member=' + route.params.id + '&key=' + barcode).then(res => {
